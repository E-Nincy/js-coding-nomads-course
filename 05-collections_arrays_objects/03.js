...
// 4. Number of each type of store
let storeCounts = {};
...
for (let name in storeCounts) {
  console.log(`There are ${storeCounts[name]} ${name}s in total.`);
}
